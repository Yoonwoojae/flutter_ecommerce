...
class CartPageState extends State<CartPage> {
  ...
  void initState() {
    ...
    StripeSource.setPublishableKey(
        'pk_test_4TbuO6qAW2XPuce1Q6ywrGP200NrDZ2233');
  }
    ...
    return showDialog(
      ...
      _checkoutCartProducts() async {
        ...
        http.Response response =
            await http.post('http://10.101.44.37:1337/orders', body: {
